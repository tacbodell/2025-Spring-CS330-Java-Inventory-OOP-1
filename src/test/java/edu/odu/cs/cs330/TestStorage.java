...
public class TestStorage
{
    ...
    {
        List<Item> items = Arrays.asList(boots, tomato, tomato);
        ...
        assertThat(inv.percentFilled(), equalTo(50));

        String invAsStr = inv.toString();
        assertThat(invAsStr, stringContainsInOrder(Arrays.asList("50%", "of", "4", "slots")));
